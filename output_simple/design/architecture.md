# Functional Specification Template Architecture
...
- **ID:** COMP-022
- **Responsibilities:**
  - Handle HTTP requests for Category
- **Handles Entities:** Category

#### TagController
- **Type:** controller
- **ID:** COMP-025
- **Responsibilities:**
  - Handle HTTP requests for Tag
- **Handles Entities:** Tag

#### NotificationController
- **Type:** controller
- **ID:** COMP-028
- **Responsibilities:**
  - Handle HTTP requests for Notification
- **Handles Entities:** Notification

#### ListController
- **Type:** controller
- **ID:** COMP-031
- **Responsibilities:**
  - Handle HTTP requests for List
- **Handles Entities:** List
...
- **Responsibilities:**
  ...
  - Orchestrate Category operations
- **Handles Entities:** Category
...
- **ID:** COMP-026
- **Responsibilities:**
  - Business logic for Tag
  - Orchestrate Tag operations
- **Handles Entities:** Tag
...
- **Responsibilities:**
  ...
  - Orchestrate Notification operations
- **Handles Entities:** Notification
...
- **ID:** COMP-024
- **Responsibilities:**
  - Data persistence for Category
  - Database queries for Category
- **Handles Entities:** Category
...
- **ID:** COMP-027
- **Responsibilities:**
  - Data persistence for Tag
  - Database queries for Tag
- **Handles Entities:** Tag
...
- **ID:** COMP-030
- **Responsibilities:**
  - Data persistence for Notification
  - Database queries for Notification
- **Handles Entities:** Notification
...
- **ID:** COMP-033
- **Responsibilities:**
  - Data persistence for List
  - Database queries for List
- **Handles Entities:** List
